...
######### 1. Reads and cleans the Pesquisa de Informações Básicas Municipais - MUNIC by IBGE ###########################
...
controls <- controls %>% mutate(cod = substr(controls$cod,1,nchar(controls$cod)-1)) %>%
  mutate(cod = as.integer(cod))

pq_bartik <- pq_bartik %>% dplyr::select(c("cod", "municip", "year", "log_pq_shares")) %>%
  as_tibble()

pq_bartik_munic <- pivot_wider(pq_bartik, values_from = "log_pq_shares", names_from = "year")

pq_bartik_munic <- pq_bartik_munic %>% mutate(cod = substr(pq_bartik_munic$cod,1,nchar(pq_bartik_munic$cod)-1)) %>%
  mutate(cod = as.integer(cod))

# 2004
path_2004 <- "C:/Users/Andrei/Desktop/Dissertation/Dados/Dados Municípios/Munic/MUNIC_2004.xls"
...
munic_2004 <- munic_2004 %>% dplyr::select(c("A1", "A164", "A28", "A29", "A30", "A31", "A33", "A34", "A35", "A36", "A37", 
                                             "A38", "A39", "A40", "A41", "A42", "A43", "A44", "A45", "A46", 
                                             "A47", "A48", "A49", "A50", "A51", "A99", "A100"))

#Merging controls and all bartik-measure years
munic_2004_bartik <- munic_2004 %>% dplyr::select(-c("A1", "A164")) %>% mutate_if(is.character, as.numeric) %>%
...
# 2005
path_2005 <- "C:/Users/Andrei/Desktop/Dissertation/Dados/Dados Municípios/Munic/MUNIC_2005.xls"
...
munic_2005 <- munic_2005 %>% dplyr::select(c("A1", "A326", "A103", "A104", "A105", "A106", "A107",
...
# 2006
path_2006 <- "C:/Users/Andrei/Desktop/Dissertation/Dados/Dados Municípios/Munic/MUNIC_2006.xls"
...
munic_2006 <- munic_2006 %>% dplyr::select(c("A1", "A357", "A18", "A19", "A20", "A21", "A22", "A23",
...
#Merging controls and all bartik-measure years
munic_2006_bartik <- munic_2006 %>% dplyr::select(-c("A1", "A357")) %>% mutate_if(is.character, as.numeric) %>%
...
munic_2006_final <- munic_2006_final %>% rename(pq_2000 = "2000", pq_2001 = "2001", pq_2002 = "2002",
                     pq_2003 = "2003", pq_2004 = "2004", pq_2005 = "2005", pq_2006 = "2006", 
                     pq_2007 = "2007", pq_2008 = "2008", pq_2009 = "2009", pq_2010 = "2010", 
                     pq_2011 = "2011", pq_2012 = "2012", pq_2013 = "2013", pq_2014 = "2014", 
                     pq_2015 = "2015")
...
# 2008
path_2008 <- "C:/Users/Andrei/Desktop/Dissertation/Dados/Dados Municípios/Munic/MUNIC_2008.xls"
...
# 2009
path_2009 <- "C:/Users/Andrei/Desktop/Dissertation/Dados/Dados Municípios/Munic/MUNIC_2009.xls"
...
munic_2009 <- munic_2009 %>% dplyr::select(c("A1", "A85", "A86", "A87", "A88", "A89", "A90", "A91",
                                             "A92", "A93", "A94", "A95", "A96", "A97", "A98", 
                                             "A348", "A349", "A247", "A450", "A409", "A410", "A411", 
                                             "A412", "A413"))
...
munic_2009_final <- munic_2009_final %>% rename(pq_2000 = "2000", pq_2001 = "2001", pq_2002 = "2002",
                                                pq_2003 = "2003", pq_2004 = "2004", pq_2005 = "2005", pq_2006 = "2006", 
                                                pq_2007 = "2007", pq_2008 = "2008", pq_2009 = "2009", pq_2010 = "2010", 
                                                pq_2011 = "2011", pq_2012 = "2012", pq_2013 = "2013", pq_2014 = "2014", 
                                                pq_2015 = "2015")
...
# 2011
path_2011 <- "C:/Users/Andrei/Desktop/Dissertation/Dados/Dados Municípios/Munic/MUNIC_2011.xls"
...
#munic_2011 <- munic_2011 %>% mutate_all(function(x) ifelse(x ==(grepl('^[0-9.]+$')), as.numeric(x), x))
