...
\end{table}
\noalign{\vskip 0.25cm}
\textbf{Panel D.} & \multicolumn{4}{c}{Log Machine Per Workers}\\
\noalign{\vskip 0.1cm}
BB Branch           &       0.124*  &       0.001   &       0.134*  &       0.011   \\
                    &     (0.070)   &     (0.062)   &     (0.070)   &     (0.063)   \\
\noalign{\vskip 0.1cm}
\noalign{\vskip 0.3cm}
\hline
\noalign{\vskip 0.1cm}
State-Year FE & \multicolumn{1}{c}{} & \multicolumn{1}{c}{\checkmark} & \multicolumn{1}{c}{\checkmark} & \multicolumn{1}{c}{\checkmark}\\
No State Capitals  & & & \multicolumn{1}{c}{\checkmark} & \multicolumn{1}{c}{\checkmark}\\
Observations        &      12,236   &      12,236   &      12,119   &      12,119   \\
Adj. $ R^{2} $      &       0.781   &       0.810   &       0.782   &       0.811   \\
\hline
\end{tabular}
\end{tablenotes}
\end{threeparttable}
